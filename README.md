...
[![Platform](https://img.shields.io/badge/platform-macOS%20|%20Linux%20|%20Windows-lightgrey.svg)](https://github.com/yourusername/VibeNotification)
...
```bash
# 从 GitHub 安装
pip install git+https://github.com/yourusername/VibeNotification.git
...
### 1. 作为 Claude Code 钩子使用

VibeNotification 主要设计为 Claude Code 的钩子，在会话结束时自动发送通知。
